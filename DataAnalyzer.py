...
class DataAnalyzer(DataProcessor):
    ...
    def calculate_projection(self, vector1, vector2):
        ...
        return np.dot(vector1, vector2) * vector2_unit
    ...
    def generate_permutations(self, col):
        "Generate permutations of unique values in a column."
        unique_values = self.get_unique_values(col)
        # result of itertools.permutations is an iterator and is converted to a list
        return list(itertools.permutations(unique_values))

    def generate_combinations(self, col, n):
        "Generate combinations of unique values in a column."
        unique_values = self.get_unique_values(col)
        # result of itertools.combinations is an iterator and is converted to a list
...
if __name__ == "__main__":
    ...
    # Sample usage of DataAnalyzer
    analyzer = DataAnalyzer('Data.csv', None)
    ...
    vector2 = analyzer.get_position_vector(2)
    ...
    print(analyzer.generate_permutations('weathercode'))
